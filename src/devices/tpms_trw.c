...
- M:{8}  Mode/Model : 0x5c, 0x5d or 0x5e (Always 0x5c for Cline model)
- I:{32} Sensor ID
- F:{4}  Flag status : 0x6 = pressure drop (OEM) , 0x9 pressure increase (OEM) or drop (Clone), 0xb or 0xc alternatly in Motion
- N:{4}  Seq number : 0,1,2,3,0,1,2,3... for OEM, 1,2,3,4,1,2,3,4... for Clone
...
- X:{4}  Trailing bit but 0x4 OEM, 0x0 Clone
